<?php
namespace Modules\Entity\Model\Slider2;
...
class Model extends ModelParent {
	...
	protected $fillable = ['photo','name','usluga_id','description','user_id','subtitle','gallery','price'];
	
	public function usluguBind()
    {
        return $this->hasOne(Uslugi::class, 'id','usluga_id');
    }
